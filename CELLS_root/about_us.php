          ...
          <div class="card mb-3 flex-fill bg-light card-team">
              <div class="row g-0">
                  <div class="overflow-hidden col-md-4">
                    <img src="CELLS_Admin/img/<?=$Foto?>" class="img-fluid img-team" alt="Foto <?=$nama?>">
                  </div>
                  <div class="col-md-8">
                      <div class="card-body">
                          ...
                          data-foto="CELLS_Admin/img/<?=$Foto?>"
  ...
  <!-- <div class="modal fade" id="modalSelengkapnnya" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body text-center">
          <img src="./CELLS_Admin/img/" class="img-fluid rounded-start" alt="..." width="100px" height="100px">
